...
BASE_IMAGE_URL = "ipfs://bafybeiedituuxuoa6gvixplk42bjf2sagv4tbom5m3xwxdruposcdbecvy"
BASE_NAME = "Test-Nomadz-Male"
...
def main():
    ...
    for idx, row in progressbar(df.iterrows()):    
        ...
        item_json_path = os.path.join(json_path, str(idx).zfill(zfill_count) + '.json')
